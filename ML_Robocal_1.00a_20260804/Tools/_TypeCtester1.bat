...
LANRS-Diags.exe /E -ip 192.168.1.51 -f "E:\Diags\Jalama\Tools\TypeCtester1\_TypeC_DUT_TBT01.bat" -w -ex -timeout 120
if %errorlevel% neq 0 goto fail

rem Copy Log from DUT 
REM .\LANRS-Diags.exe /QD -ip 192.168.1.51 -rf "E:\Diags\Jalama\Tools\Temp" -to "." -w -e 0 -timeout 30

mkdir .\Temp\TypeC1_log_%TypeC_TestItems_Count%_pass
.\LANRS-Diags.exe /QD -ip 192.168.1.51 -rf "E:\Diags\Jalama\Tools\Temp\TypeC_log1" -to ".\Temp\TypeC1_log_%TypeC_TestItems_Count%_pass" -w -e 0 -timeout 30
...
mkdir .\Temp\TypeC1_log_%TypeC_TestItems_Count%_fail
.\LANRS-Diags.exe /QD -ip 192.168.1.51 -rf "E:\Diags\Jalama\Tools\Temp\TypeC_log1" -to ".\Temp\TypeC1_log_%TypeC_TestItems_Count%_fail" -w -e 0 -timeout 30
